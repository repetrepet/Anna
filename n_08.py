# =============================================================================
# Задание № 8 ЕГЭ — комбинаторика и перебор слов
# =============================================================================
...
# =============================================================================
# Задача 8: Поиск слова по номеру (product)
# =============================================================================
...
for number, i in enumerate(product(alph, repeat=5)):
    ...
    if number == 209:
        print(f"Задача 8: {i}") # Выведет кортеж букв ('А', 'О', 'А', 'А', 'У') и т.п.


# =============================================================================
# Задача 9: Поиск слова по номеру со сдвигом (product)
# =============================================================================
...
# =============================================================================
# Задача 10: Поиск номера первого слова по условию (product + break)
# =============================================================================
...
for number, i in enumerate(product(alph, repeat=5)):
    ...
    if i[0] == 'К':
        ...
        print(f"Задача 10: {number + 1}")
        break # Прерываем цикл, так как нужно только ПЕРВОЕ такое слово.


# =============================================================================
# Задача 11: Поиск номера конкретного слова (product)
# =============================================================================
# Все 5-буквенные слова, составленные из букв А, К, Р, У, записаны в алфавитном порядке.
...
for number, i in enumerate(product(alph, repeat=5)):
    ...
    if i == ('У', 'К', 'А', 'Р', 'А'):
        ...
        print(f"Задача 11: {number + 1}")


# =============================================================================
# Задача 12: Перестановки букв без повторений (permutations)
# =============================================================================
...
# =============================================================================
# Задача 13: Сложные условия фильтрации
# =============================================================================
...
for index, i in enumerate(product(alph, repeat=5)):
    ...
    if condition_even_number and condition_start and condition_count:
        ...
        print(f"Задача 13 (кандидат): {index + 1}")
...
Общая идея решения:
Генерируем все возможные пятибуквенные слова из заданного алфавита в лексикографическом (алфавитном) порядке 
с помощью функции product из модуля itertools. Для каждого слова подсчитываем количество гласных букв ('и' и 'ю'). 
Если их ровно 2, выводим номер слова и само слово. Так как перебор идёт строго в алфавитном порядке, 
последнее выведенное значение номера и будет искомым ответом на задачу.
"""

from itertools import product

# Задаем алфавит в строгом алфавитном порядке: И, Н, Ь, Ю.
# Это критически важно, так как функция product генерирует комбинации в лексикографическом порядке 
# относительно той последовательности символов, которая передана в строке.
alph = 'инью'

# Инициализируем счетчик номеров слов, начиная с 1
number = 1

# Перебираем все возможные комбинации (слова) длиной 5 символов с повторениями
for word in product(alph, repeat=5):
    
    # Подсчитываем общее количество гласных букв в текущем слове.
    # В алфавите "ИЮНЬ" гласными являются только 'и' и 'ю'.
    # Метод count корректно работает с кортежем символов, который возвращает product.
    x = word.count('и') + word.count('ю')
    
    # Проверяем условие задачи: слово должно содержать ровно 2 гласные буквы
    if x == 2:
        # Выводим номер и само слово.
        # Поскольку перебор последовательный, последняя выведенная строка в консоли даст ответ на задачу.
        print(number, word)
    
    # Увеличиваем счетчик номеров для следующей итерации (следующего слова в списке)
    number += 1
